...
class Reports {
    ...
    private void printTransportInformation(List<Resources> resources){
    ...
    private void printTrainingCenterInformation(List<Resources> resources){
        Control control = new Control();
    ...
    private void printStadiumInformation(List<Resources> resources){
        Control control = new Control();
    ...
    void general(List<Employee> employees, List<Resources> resources, List<Partner> partners){
        Scanner input = new Scanner(System.in);
