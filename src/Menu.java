...
public class Menu {
    ...
    private static void gerenciarFuncionarios(List<Funcionario> funcionarios){
        Scanner input = new Scanner(System.in);
        String option = "10";
    ...
    public static boolean loginPage(String admin_user, String admin_password, List<Funcionario> funcionarios, List<Socio> socios, Niveis niveis, List<Onibus> onibus, Estadio estadio, CT centro_treinamento){
        Scanner input = new Scanner(System.in);
